...
**Table 1:** Comparison between MyVLM [[9]](#ref-9), Yo'LLaVA [[5]](#ref-5) and ReGraP datasets. # Avg. is the average number of objects in multi-object sets. Len. is the average number of steps in the QA pairs.
...
| LLaVA [[32]](#ref-32) (Raw) | 0.865 | 0.762 | 0.863 | 0.753 | 0.893 | 0.840 | 0.850 | 0.796 |
...
- <a id="ref-15"></a>[15] Guowei Xu, Peng Jin, Li Hao, Yibing Song, Lichao Sun, and Li Yuan. Llava-o1: Let vision language models reason step-by-step. *arXiv preprint arXiv:2411.10440*, 2024.
...
![The image is a close-up of a beverage cup with a wooden lid and spoon, featuring an anime character print. Responses analyze the image, noting the cup's design elements (wooden lid, anime print, vibrant colors), suggesting it's both functional and collectible, and appealing to anime fans. The image's purpose is to illustrate a specific type of designed cup.](_page_16_Picture_2.jpeg)
...
![That's not a technical image from an academic paper. It's a photograph of a desk calendar featuring an anime-style character. There are no diagrams, charts, graphs, equations, or technical illustrations present. The image is irrelevant to any academic context and appears to be a personal item accidentally included.](_page_34_Picture_2.jpeg)
...
| ReGraP-LLaVA: | <rog_mouse> features a modern, ambidextrous shape with a dual-tone design. It has light grey buttons and a white body. The scroll wheel has ribbed texture for improved tactile feedback, and additional programmable side buttons are ergonomically positioned for thumb access. The smooth curvature conforms to the user's palm, supporting various grip styles, particularly fingertip and claw. The ROG logo, illuminated in cyan blue, not only provides a customized visual identity but may also indicate battery or DPI status depending on configuration. The mouse's lightweight frame and well-distributed button placement suggest it is built for gaming or high-speed use scenarios where control and comfort are both essential.</rog_mouse> |
