...
<!-- Image Description: The image is not a diagram, chart, graph, equation, or technical illustration. It's a placeholder graphic indicating that the reader should check for updates to the content of the academic paper. The image shows a button or icon with a circular progress indicator and a bookmark, overlaid with the text "Check for updates". Its purpose is purely informational, directing the reader to seek a more current version of the material. -->
...
<!-- Image Description: This flowchart outlines a research paper's structure. It details three main sections: HPC storage (covering system architecture, storage stack components like HDF5 and Lustre, and key parameter analysis); auto-tuning in HPC I/O (including its definition, framework, key elements, and challenges); and approaches to auto-tuning (heuristic, rule-based, simulation-based, machine learning-based, hybrid, and a summary). The flowchart visually organizes the paper's content and subtopics. -->

<span id="page-2-0"></span>**Figure 1** Organization of the survey

![](_page_2_Figure_4.jpeg)
<!-- Image Description: The diagram illustrates a distributed computing system architecture. It shows compute nodes, storage nodes, and forwarding nodes interconnected via a high-speed network. Data flows between compute nodes and storage nodes through the forwarding nodes. The storage nodes are depicted as containing storage servers and devices, and metadata servers manage the system's data. The diagram's purpose is to visually represent the system's components and their interactions. -->

<span id="page-2-1"></span>**Figure 2** Overall architecture of HPC system
...
<!-- Image Description: The image displays a layered architecture diagram of High-Performance Computing (HPC) I/O. From top to bottom, layers represent: HPC application, high-level I/O library (HDF5, NetCDF, ADIOS), I/O middleware (MPI-IO), low-level I/O library (POSIX), parallel file system (Lustre, GPFS, PVFS2, BeeGFS), and storage devices. Each layer's function and relevant technologies are described, illustrating the data flow and interactions between software components and hardware. -->
...
<!-- Image Description: This diagram illustrates the architecture and data flow of an HDF5-based system. It shows the HDF5 file format's structure (contiguous, chunked, compact), data creation and access processes (H5Dcreate, H5Dwrite, H5Dopen, H5Dread), and I/O operations using POSIX and MPI-IO. The diagram also depicts the memory hyperslab operations (scatter/gather), data type conversion, and the system's interaction with physical storage (local, network-connected, and distributed). The overall purpose is to describe the technical implementation details of the system. -->

<span id="page-4-0"></span>**Figure 4**The complete I/O process taking HDF5 as an example
...
<!-- Image Description: The figure is a flowchart depicting an automated parameter optimization system. Inputs include a parameter space, benchmark/kernel, and log files. These feed into an optimization engine, which generates configurations for a prediction model. The engine receives prediction and running results back from the model, iteratively refining the configurations until optimal parameters are found. -->

<span id="page-6-3"></span><span id="page-6-2"></span>**Figure 5**A general auto-tuning framework
...
<!-- Image Description: The image is a headshot photograph of an individual, likely an author or contributor to the academic paper. It contains no diagrams, charts, graphs, equations, or technical illustrations; it is purely a personal photograph and serves only as an author identification within the paper. -->

![](_page_23_Picture_10.jpeg)
<!-- Image Description: The image is a headshot photograph of a young man with short dark hair, wearing a dark gray zip-up jacket. It appears to be an author photograph for an academic paper, providing a visual representation of the author. There are no diagrams, charts, graphs, equations, or other technical illustrations present; the image is purely a portrait. -->
...
<!-- Image Description: The image is a headshot photograph of a young woman with long dark hair, wearing a black blazer. It is not a diagram, chart, graph, or technical illustration; rather, it appears to be an author photograph for an academic paper. The image's purpose is to visually identify the author. -->
...
<!-- Image Description: The image is a headshot photograph of a man, likely an author or contributor to the academic paper. It contains no diagrams, charts, graphs, equations, or other technical illustrations; it is solely a portrait for identification purposes. Its purpose is to provide a visual representation of the individual associated with the work. -->

![](_page_23_Picture_17.jpeg)
<!-- Image Description: The image is a headshot of a man in a suit and glasses. It's not a technical image containing diagrams, charts, graphs, or equations. It is likely an author photograph included to identify the contributor to the academic paper. The image serves solely as an author portrait and has no technical content. -->
...
<!-- Image Description: The image is a photograph of a person, likely an author or contributor to the academic paper. It's a standard portrait headshot against a solid blue background. The individual is wearing glasses and a white collared shirt with a black necktie. The image serves solely as an identification photo, providing a visual representation of the person associated with the research presented in the paper. There are no diagrams, charts, graphs, or equations present. -->
