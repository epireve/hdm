#!/usr/bin/env python3
"""
Comprehensive Paper.md Standardizer using Gemini 2.5 Pro via Kilocode API

This script standardizes all paper.md files in the markdown_papers directory
to ensure consistency, integrity, and both human and machine readability.
"""
...
Return ONLY the standardized markdown content, no explanations."""
    ...
    def run(self, specific_papers: Optional[List[str]] = None):
        ...
        # Process in batches
        with tqdm(total=len(papers_to_process), desc="Standardizing papers") as pbar:
