...
<!-- Image Description: This figure presents horizontal bar charts comparing the accessibility of essential medicines across three countries (Burundi, China, and Haiti). Each chart displays the proportion of medicines available only, and available and affordable, categorized by type (e.g., amoxicillin suspension, ibuprofen tablet). The charts show varying levels of accessibility for different medications within each country, highlighting disparities in affordability and availability of essential medicines. The purpose is to illustrate the differences in medicine access across different nations and medication types. -->
