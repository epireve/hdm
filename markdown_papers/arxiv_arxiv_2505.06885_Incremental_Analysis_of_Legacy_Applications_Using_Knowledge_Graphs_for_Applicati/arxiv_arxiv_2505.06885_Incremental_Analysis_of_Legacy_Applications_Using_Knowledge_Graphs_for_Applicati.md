...
# 2.1 Code Discovery and Knowledge Graph ConstrucJon
...
# 2.2 Increment CreaJon via Neighbourhood DetecJon
...
To aid in this process, we introduce the concept of an *increment*. We define an *increment* to be a bounded scope containing *seed* 
