...
Problem 1 (Event Prediction Task). *Given head entity s and tail entity o, the event prediction task in TKGs aims to predict relations for timestep T , based on the set of historical events* G1:*<sup>T</sup>* <sup>−</sup>1*.*
