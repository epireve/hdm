...
The outline of the whole network structure is shown in Fig.1. It mainly consists of three parts: preprocessing, temporal feature extraction and multi-channel graph connvolution in graph learning.
