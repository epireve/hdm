...
**Figure 2: An illustrative diagram of the proposed RE-GCN model for temporal reasoning at timestamp** + 1**.**
...
<span id="page-6-1"></span>**Table 3: Performance (in percentage) for the entity prediction task on ICEWS18, ICESW14 and ICEWS05-15 with raw metrics.**
