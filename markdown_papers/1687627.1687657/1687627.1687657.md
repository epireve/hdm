...
## 4.1 Category C - Session Consistency
...
## 5.3 Policies for numeric types
...
## 6.5 Statistical component and policies
...
## 6.6 Implementation Alternatives
...
## 7.2 Experiment 1: Cost per transaction
...
## 7.3 Experiment 2: Response time
...
## 7.5 Experiment 4: Fixed threshold
