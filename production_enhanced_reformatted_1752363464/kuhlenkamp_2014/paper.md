...
![Throughput for Workload R.](_page_3_Figure_10.jpeg)
(a) Throughput for Workload R.

![Cassandra read latency for Workload R.](_page_3_Figure_13.jpeg)
(b) Cassandra read latency for Workload R.

![HBase read latency for Workload R.](_page_3_Figure_14.jpeg)
(c) HBase read latency for Workload R.
...
![Workload W performance comparison.](_page_4_Figure_8.jpeg)
(a) Throughput for Workload W.

![HBase write latency for Workload W.](_page_4_Figure_9.jpeg)
...
![Cassandra read latency for Workload R.](_page_5_Figure_0.jpeg)
(a) Cassandra read latency for Workload R.

![Cassandra write latency for Workload W.](_page_5_Figure_1.jpeg)
(b) Cassandra write latency for Workload W.

![Cassandra scan latency for Workload RS.](_page_5_Figure_2.jpeg)
(c) Cassandra scan latency for Workload RS.

**Figure 3:** Target workloads Cassandra.

![HBase target workloads.](_page_5_Figure_4.jpeg)
...
![Workload RS throughput.](_page_6_Figure_0.jpeg)
(a) Throughput for Workload RS.

![Cassandra scan latency for Workload RS.](_page_6_Figure_2.jpeg)
(b) Cassandra scan latency for Workload RS.

![HBase scan latency for Workload RS.](_page_6_Figure_4.jpeg)
(c) HBase scan latency for Workload RS.
...
![Histogram of read latencies for workload R measured by a single YCSB-client for a HBase 12-node cluster.](_page_6_Figure_8.jpeg)
...
![Throughput of a 4-node Cassandra cluster and a 4-node HBase cluster for different EC2 instance types.](_page_6_Figure_12.jpeg)
...
![Relative increase of average read and write latency for increasing thread counts over a baseline of 32 threads for a 4-node HBase cluster and workload W.](_page_7_Figure_2.jpeg)
...
![Cassandra throughput and server CPU wait IO time series measurements for a cluster with 10GB/node vs. 20GB/node.](_page_8_Figure_3.jpeg)
...
![Comparison of Cassandra performance for EC2 Storage Setups S1-S4.](_page_8_Figure_16.jpeg)
...
![Relative decrease of HBase average throughput [ops/s] for simultaneous addition of varying numbers of nodes.](_page_9_Figure_10.jpeg)
...
![Cassandra read latency for scaling scenarios CS-1, CS-2, CS-3, CS-4, and CS-7.](_page_10_Figure_10.jpeg)
**Figure 12:** Cassandra read latency for scaling scenarios CS-1, CS-2, CS-3, CS-4, and CS-7.

![Update latency before, during, and after scaling.](_page_10_Figure_12.jpeg)

![Cassandra update latency for scaling scenarios CS-1, CS-2, CS-3, CS-4, and CS-7.](_page_10_Figure_13.jpeg)
